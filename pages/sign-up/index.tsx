...
const Register: FC = (props) => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (name === "") {
      setInValidName(true);
      setInValidNameMessage("Name is required!"); 
      return;
    } else {
          ...
          <Stack className={styles.paper}  sx={{maxWidth: {xs: "100%", sm: "100%"}}}>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
              ...
              <TextField
                ...
                data-test="name"
              />
              <Typography component="p" color="error" data-test="name-error">{inValidNameMessage}</Typography>
              ...
              <TextField
                ...
                data-test="email"
              />
              <Typography component="p" color="error" data-test="email-error">{inValidEmail ? inValidEmailMessage : ""}</Typography>
              <TextField
                ...
                data-test="password"
              />
              <Typography component="p" color="error" data-test="password-error">{inValidPasswordMessage}</Typography>
              ...
              >{inValidConfirmPasswordMessage}</Typography>
