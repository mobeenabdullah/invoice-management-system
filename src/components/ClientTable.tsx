        ...
        <>  
            <Wrapper>              
                ...
                {isError && (
                    ...
                    {isLoading && (
                        <Card sx={{ minHeight: "388px", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>    
                                    ...
                                    <Table sx={{ minWidth: 650 }} aria-label="simple table" data-test='clients-table' >
                                        ...
                                        {clientRows.length > 0 && clientRows.map((row: any) => (
                                            ...
                                            >
                                                ...
                                                <TableCell align="left" data-test='client-email'onClick={() => navigate(`/clients/${row.id}`)} sx={{ cursor: "pointer" }}>{row.email}</TableCell>
